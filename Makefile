...
ApolloReborn_FILES = \
    ...
    $(SRC_DIR)/fishhook.c \
    $(SSZIPARCHIVE_FILES)
ApolloReborn_FRAMEWORKS = UIKit Security AVFoundation OSLog NaturalLanguage ImageIO StoreKit PhotosUI SafariServices SystemConfiguration WebKit AuthenticationServices CoreImage
